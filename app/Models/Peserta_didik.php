...
class Peserta_didik extends Model
{
	...
	{
        return isset($this->attributes['tempat_lahir']) ?strtoupper($this->attributes['tempat_lahir']).', '.strtoupper(Carbon::parse($this->attributes['tanggal_lahir'])->translatedFormat('d F Y')) : '';
	}
