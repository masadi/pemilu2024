...
const data = {
  ...
  timeline: {
    ...
    step3: {
      ...
      duration: '2 day ago',
      avatars: [
        { userImg: '/images/portrait/small/avatar-s-9.jpg', name: 'Billy Hopkins' },
        { userImg: '/images/portrait/small/avatar-s-6.jpg', name: 'Amy Carson' },
        { userImg: '/images/portrait/small/avatar-s-8.jpg', name: 'Brandon Miles' },
        { userImg: '/images/portrait/small/avatar-s-7.jpg', name: 'Daisy Weber' },
        { userImg: '/images/portrait/small/avatar-s-20.jpg', name: 'Jenny Looper' },
      ],
    },
    step4: {
      title: 'Create a new project for client',
  ...
  appDesign: {
    ...
    members: [
      { img: '/images/portrait/small/avatar-s-9.jpg', color: 'primary' },
      { text: 'PI', color: 'light-danger' },
      { img: '/images/portrait/small/avatar-s-14.jpg', color: 'primary' },
      { img: '/images/portrait/small/avatar-s-7.jpg', color: 'primary' },
