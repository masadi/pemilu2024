...
const data = {
  ...
  blogList: [
    ...
    },
    {
      ...
      avatar: '/images/portrait/small/avatar-s-14.jpg',
  ...
  blogSidebar: {
    recentPosts: [
      ...
      {
        id: 8,
        img: '/images/banner/banner-27.jpg',
  ...
  blogEdit: {
    ...
    featuredImage: '/images/slider/03.jpg',
  },
}
/* eslint-disable global-require */
