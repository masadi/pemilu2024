...
export default function useCalendarEventHandler(props, clearForm, emit) {
  ...
  const guestsOptions = [
    { avatar: '/images/avatars/1-small.png', name: 'Jane Foster' },
    { avatar: '/images/avatars/3-small.png', name: 'Donna Frank' },
    { avatar: '/images/avatars/5-small.png', name: 'Gabrielle Robertson' },
    { avatar: '/images/avatars/7-small.png', name: 'Lori Spears' },
    { avatar: '/images/avatars/9-small.png', name: 'Sandy Vega' },
    { avatar: '/images/avatars/11-small.png', name: 'Cheryl May' },
  ]
