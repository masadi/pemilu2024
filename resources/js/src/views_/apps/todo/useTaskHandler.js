...
export default function useTaskHandler(props, emit) {
  ...
  const assigneeOptions = [
    { avatar: '/images/avatars/1-small.png', fullName: 'Jane Foster' },
    { avatar: '/images/avatars/3-small.png', fullName: 'Donna Frank' },
    { avatar: '/images/avatars/5-small.png', fullName: 'Gabrielle Robertson' },
    { avatar: '/images/avatars/7-small.png', fullName: 'Lori Spears' },
    { avatar: '/images/avatars/9-small.png', fullName: 'Sandy Vega' },
    { avatar: '/images/avatars/11-small.png', fullName: 'Cheryl May' },
  ]
