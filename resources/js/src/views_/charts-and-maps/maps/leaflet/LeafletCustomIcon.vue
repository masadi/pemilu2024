...
Icon.Default.mergeOptions({
  iconRetinaUrl: '/images/leafletmarker-icon-2x.png',
  iconUrl: '/images/leafletmarker-icon.png',
  shadowUrl: '/images/leafletmarker-shadow.png',
})
