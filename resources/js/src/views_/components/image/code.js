...
<template>
  <div class="clearfix">
    <b-img  left class="mb-1 mb-sm-0" height="120" :src="'/images/banner/banner-34.jpg" alt="Left image')"/>
    <b-img right class="mb-1 mb-sm-0" height="120" :src="'/images/banner/banner-34.jpg" alt="Right image')"/>
    <b-img center class="mb-1 mb-sm-0" height="120" :src="'/images/banner/banner-34.jpg" alt="Center image')"/>
  </div>
</template>
...
<template>
  <div>
    ...
    <b-img :src="'/images/water-drop-small.jpg" fluid alt="Fluid image')" />

    <h6 class="my-1">Small image with <code>fluid-grow</code>:</h6>
    <b-img :src="'/images/water-drop-small.jpg" fluid-grow alt="Fluid-grow image')" />
  </div>
</template>
...
<template>
  <b-container fluid class="p-1 bg-dark">
    <b-row>
      <b-col>
        <b-img thumbnail fluid :src="'/images/sky-high.jpg" alt="Image 1')" />
      </b-col>
      <b-col>
        <b-img thumbnail fluid :src="'/images/light-house-thumb.jpg" alt="Image 2')" />
      </b-col>
      <b-col>
        <b-img thumbnail fluid :src="'/images/border.jpg" alt="Image 3')" />
      </b-col>
    </b-row>
  </b-container>
</template>
...
<template>
  <div>
    <b-img-lazy :src="'/images/banner/banner-6.jpg" fluid class="w-100')"/>
  </div>
</template>
