...
<template>
  <b-carousel
    ...
    indicators
  >
    <b-carousel-slide :img-src="'/images/slider/01.jpg'" />
    <b-carousel-slide :img-src="'/images/slider/02.jpg'" />
    <b-carousel-slide :img-src="'/images/slider/03.jpg'" />
  </b-carousel>
</template>
...
<template>
  <div>
    ...
    >
      ...
      <b-carousel-slide :img-src="'/images/slider/06.jpg'" />
...
<template>
  ...
  >
    <b-carousel-slide :img-src="'/images/slider/01.jpg'" />
    <b-carousel-slide :img-src="'/images/slider/02.jpg'" />
    <b-carousel-slide :img-src="'/images/slider/04.jpg'" />
  </b-carousel>
</template>
...
<template>
  ...
  >
    <b-carousel-slide :img-src="'/images/slider/04.jpg'" />
    <b-carousel-slide :img-src="'/images/slider/05.jpg'" />
    <b-carousel-slide :img-src="'/images/slider/06.jpg'" />
  </b-carousel>
</template>
...
<template>
  <b-carousel
    ...
    :interval="400"
  >
    <b-carousel-slide :img-src="'/images/slider/07.jpg'" />
    <b-carousel-slide :img-src="'/images/slider/08.jpg'" />
    <b-carousel-slide :img-src="'/images/slider/09.jpg'" />
  </b-carousel>
</template>
