...
<template>
  <div class="media-list media-bordered">
    ...
    <b-media>
      <template #aside>
        <b-img
          :src="'/images/portrait/small/avatar-s-16.jpg'"
          blank-color="#ccc"
          width="64"
          alt="placeholder"
        />
...
<template>
  <b-media>
    <template #aside>
      <b-img
        :src="'/images/portrait/small/avatar-s-12.jpg'"
        blank-color="#ccc"
        width="64"
        alt="placeholder"
      />
    ...
    <b-media class="mt-3">
      <template #aside>
        <b-img
          :src="'/images/portrait/small/avatar-s-13.jpg'"
          blank-color="#ccc"
          width="64"
          alt="placeholder"
        />
...
<template>
  <div class="media-list">
    ...
    >
      <template #aside>
        <b-img
          :src="'/images/portrait/small/avatar-s-10.jpg'"
          blank-color="#ccc"
          width="64"
          alt="placeholder"
          rounded="circle"
    ...
    >
      <template #aside>
        <b-img
          :src="'/images/portrait/small/avatar-s-2.jpg'"
          blank-color="#ccc"
          width="64"
          alt="placeholder"
          rounded="circle"
...
<template>
  <div class="media-list media-bordered">
    ...
    >
      <template #aside>
        <b-img
          :src="'/images/portrait/small/avatar-s-21.jpg'"
          blank-color="#ccc"
          width="64"
          alt="placeholder"
          rounded="circle"
...
<template>
  <div class="media-list media-bordered">
    <b-media vertical-align="top">
      <template #aside>
        <b-img
          :src="'/images/portrait/small/avatar-s-4.jpg'"
          blank-color="#ccc"
          width="64"
          alt="placeholder"
        />
