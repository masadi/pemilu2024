...
export default {
  ...
  data() {
    return {
      ...
      browserData: [
        {
          browserImg: '/images/icons/google-chrome.png',
          name: 'Google Chrome',
          usage: '54.4%',
        },
        {
          browserImg: '/images/icons/mozila-firefox.png',
          name: 'Mozila Firefox',
          usage: '6.1%',
        },
        {
          browserImg: '/images/icons/apple-safari.png',
          name: 'Apple Safari',
          usage: '14.6%',
        },
        {
          browserImg: '/images/icons/internet-explorer.png',
          name: 'Internet Explorer',
          usage: '4.2%',
        },
        {
          browserImg: '/images/icons/opera.png',
          name: 'Opera Mini',
          usage: '8.4%',
        },
      ],
